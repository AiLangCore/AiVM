...
AIVM_API AivmCResult aivm_c_execute_program_with_syscalls(
    ...
    const AivmSyscallBinding* bindings,
    size_t binding_count);
AIVM_API AivmCResult aivm_c_execute_program_with_syscalls_and_argv(
    const AivmProgram* program,
    const AivmSyscallBinding* bindings,
    size_t binding_count,
...
AIVM_API AivmCResult aivm_c_execute_aibc1_with_argv(
    const uint8_t* bytes,
    size_t byte_count,
    const char* const* process_argv,
    size_t process_argv_count);
AIVM_API AivmCResult aivm_c_execute_aibc1_with_syscalls_and_argv(
    const uint8_t* bytes,
    size_t byte_count,
    const AivmSyscallBinding* bindings,
    size_t binding_count,
