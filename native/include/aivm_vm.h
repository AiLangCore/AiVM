...
enum {
    ...
    AIVM_VM_LOCALS_CAPACITY = 65536,
    AIVM_VM_LOCALS_INITIAL_CAPACITY = 4096,
    AIVM_VM_LOCALS_GROWTH_STEP = 2048,
    ...
    AIVM_VM_NODE_CAPACITY = 512,
    AIVM_VM_NODE_ATTR_CAPACITY = 2048,
    AIVM_VM_NODE_CHILD_CAPACITY = 4096,
