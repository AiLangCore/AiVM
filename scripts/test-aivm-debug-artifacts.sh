...
grep -q 'syscall_capability_policy_mask = 32766' "${PRODUCTION_LOAD_FAIL_RUN}/config.toml"
grep -q 'syscall_capability_policy_mask = 65534' "${POLICY_LOAD_FAIL_RUN}/config.toml"
