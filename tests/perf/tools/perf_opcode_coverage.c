...
static const PerfOpcodeCoverage g_opcode_coverage[] = {
    ...
    { AIVM_OP_WORKER_REF, "AIVM_OP_WORKER_REF", PERF_OPCODE_TRACKED_GAP, "catalog-bound worker integration unit-covered" },
    { AIVM_OP_WORKER_RUN, "AIVM_OP_WORKER_RUN", PERF_OPCODE_TRACKED_GAP, "catalog-bound worker integration unit-covered" },
    { AIVM_OP_TASK_CANCEL, "AIVM_OP_TASK_CANCEL", PERF_OPCODE_TRACKED_GAP, "queued worker cancellation unit-covered" },
    { AIVM_OP_WORKER_RUN_ALL, "AIVM_OP_WORKER_RUN_ALL", PERF_OPCODE_TRACKED_GAP, "ordered worker batch integration unit-covered" },
    { AIVM_OP_WORKER_TASK_AT, "AIVM_OP_WORKER_TASK_AT", PERF_OPCODE_TRACKED_GAP, "ordered worker batch selection unit-covered" },
