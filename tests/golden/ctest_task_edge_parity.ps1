...
Run-Case 'await_edge_invalid' `
  (Join-Path $RepoRoot 'tests/golden/parity_cases/vm_c_execute_src_await_edge_invalid.aos') `
  (Join-Path $RepoRoot 'tests/golden/parity_cases/vm_c_execute_src_await_edge_invalid.out') `
  3
Run-Case 'par_join_edge_invalid' `
  (Join-Path $RepoRoot 'tests/golden/parity_cases/vm_c_execute_src_par_join_edge_invalid.aos') `
  (Join-Path $RepoRoot 'tests/golden/parity_cases/vm_c_execute_src_par_join_edge_invalid.out') `
  3
Run-Case 'par_cancel_edge_noop' `
  (Join-Path $RepoRoot 'tests/golden/parity_cases/vm_c_execute_src_par_cancel_edge_noop.aos') `
  '' `
  0
